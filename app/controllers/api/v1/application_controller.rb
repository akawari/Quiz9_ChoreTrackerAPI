        ...
        def setup_basic_api_documentation    
            [:index, :show, :create, :update, :delete].each do |api_action|
                swagger_api api_action do
                    param :header, 'Authorization', :string, :required, 'Authentication token in the format of: Token token=19bbe2a152c611d42fbf3d1b50e38217'
                end
            end
        end
    end
...
# YWthd2FyaUBhbmRyZXcuY211LmVkdTpBaG1hZA==\n