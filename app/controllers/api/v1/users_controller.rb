...
class UsersController < ApplicationController
    ...
    # The response params here define what type of error responses can be returned back to the user from your API. 
    # In this case, the error responses are 404 not_found and not_acceptable.
